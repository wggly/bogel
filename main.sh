...
echo -e "  Auther : ${green}BOGEL TUNNELING ® ${NC}${YELLOW}(${NC} ${green} BOGEL STORE TUNNELING ${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/wggly/bogel/main/"
...
clear
izinsc="https://raw.githubusercontent.com/wggly/izin/main/ipvps"
# USERNAME
rm -f /usr/bin/user
...
<code>────────────────────</code>
<b> BOGEL STORE TUNNELING SCRIPT  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"𝙊𝙍𝘿𝙀𝙍","url":"https://t.me/bogelxd_vpn"}]]}' 
"'&reply_markup={"inline_keyboard":[[{"text":"𝙂𝙍𝙐𝙋","url":"https://t.me/bogelxd"}]]}' 
...
wget -q https://raw.githubusercontent.com/wggly/bogel/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
